...
class Annotation:
    ...
    def isPolygonGood(self, object):
        status = False

        # good polygon if the point number is larger than 2
        if len(object.polygon) > 2:
            status = True
